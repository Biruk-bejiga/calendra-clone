...
export  default function PrivateNaveBar() {
                ...
                {PrivateNavLinks.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            key={item.label}
                            className={
                                cn(`flex gap-4 items-center p-4 rounded-lg justify-start hover:scale-150 duration-300`, isActive && 'bg-blue-100 rounded-3xl')
                            }>
                            <Image
                                src={item.imgURL}
                                alt={item.label}
